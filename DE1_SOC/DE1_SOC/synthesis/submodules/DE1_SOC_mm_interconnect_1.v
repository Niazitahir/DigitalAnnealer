...
module DE1_SOC_mm_interconnect_1 (
	...
	wire  [114:0] hex5_4_s1_agent_rf_source_data;                           // HEX5_4_s1_agent:rf_source_data -> HEX5_4_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] hex5_4_s1_agent_rsp_fifo_out_data;                        // HEX5_4_s1_agent_rsp_fifo:out_data -> HEX5_4_s1_agent:rf_sink_data
	...
	wire  [114:0] hex3_0_s1_agent_rf_source_data;                           // HEX3_0_s1_agent:rf_source_data -> HEX3_0_s1_agent_rsp_fifo:in_data
	...
	wire  [114:0] hex3_0_s1_agent_rsp_fifo_out_data;                        // HEX3_0_s1_agent_rsp_fifo:out_data -> HEX3_0_s1_agent:rf_sink_data
	...
	wire          hex5_4_s1_agent_rp_valid;                                 // HEX5_4_s1_agent:rp_valid -> router_002:sink_valid
	wire  [113:0] hex5_4_s1_agent_rp_data;                                  // HEX5_4_s1_agent:rp_data -> router_002:sink_data
	wire          hex5_4_s1_agent_rp_ready;                                 // router_002:sink_ready -> HEX5_4_s1_agent:rp_ready
	wire          hex5_4_s1_agent_rp_startofpacket;                         // HEX5_4_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          hex5_4_s1_agent_rp_endofpacket;                           // HEX5_4_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          hex3_0_s1_agent_rp_valid;                                 // HEX3_0_s1_agent:rp_valid -> router_003:sink_valid
	wire  [113:0] hex3_0_s1_agent_rp_data;                                  // HEX3_0_s1_agent:rp_data -> router_003:sink_data
	wire          hex3_0_s1_agent_rp_ready;                                 // router_003:sink_ready -> HEX3_0_s1_agent:rp_ready
	wire          hex3_0_s1_agent_rp_startofpacket;                         // HEX3_0_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          hex3_0_s1_agent_rp_endofpacket;                           // HEX3_0_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          keys_s1_agent_rp_valid;                                   // KEYS_s1_agent:rp_valid -> router_005:sink_valid
	wire  [113:0] keys_s1_agent_rp_data;                                    // KEYS_s1_agent:rp_data -> router_005:sink_data
	wire          keys_s1_agent_rp_ready;                                   // router_005:sink_ready -> KEYS_s1_agent:rp_ready
	wire          keys_s1_agent_rp_startofpacket;                           // KEYS_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          keys_s1_agent_rp_endofpacket;                             // KEYS_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> HEX5_4_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> HEX5_4_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // HEX5_4_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> HEX5_4_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> HEX5_4_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> HEX5_4_s1_burst_adapter:sink0_endofpacket
	wire          hex5_4_s1_burst_adapter_source0_valid;                    // HEX5_4_s1_burst_adapter:source0_valid -> HEX5_4_s1_agent:cp_valid
	wire  [113:0] hex5_4_s1_burst_adapter_source0_data;                     // HEX5_4_s1_burst_adapter:source0_data -> HEX5_4_s1_agent:cp_data
	wire          hex5_4_s1_burst_adapter_source0_ready;                    // HEX5_4_s1_agent:cp_ready -> HEX5_4_s1_burst_adapter:source0_ready
	wire    [3:0] hex5_4_s1_burst_adapter_source0_channel;                  // HEX5_4_s1_burst_adapter:source0_channel -> HEX5_4_s1_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                    // cmd_mux_001:src_valid -> HEX3_0_s1_burst_adapter:sink0_valid
	wire  [113:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> HEX3_0_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // HEX3_0_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> HEX3_0_s1_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                            // cmd_mux_001:src_startofpacket -> HEX3_0_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                              // cmd_mux_001:src_endofpacket -> HEX3_0_s1_burst_adapter:sink0_endofpacket
	wire          hex3_0_s1_burst_adapter_source0_valid;                    // HEX3_0_s1_burst_adapter:source0_valid -> HEX3_0_s1_agent:cp_valid
	wire  [113:0] hex3_0_s1_burst_adapter_source0_data;                     // HEX3_0_s1_burst_adapter:source0_data -> HEX3_0_s1_agent:cp_data
	wire          hex3_0_s1_burst_adapter_source0_ready;                    // HEX3_0_s1_agent:cp_ready -> HEX3_0_s1_burst_adapter:source0_ready
	wire    [3:0] hex3_0_s1_burst_adapter_source0_channel;                  // HEX3_0_s1_burst_adapter:source0_channel -> HEX3_0_s1_agent:cp_channel
	...
	wire          hex5_4_s1_agent_rdata_fifo_out_valid;                     // HEX5_4_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] hex5_4_s1_agent_rdata_fifo_out_data;                      // HEX5_4_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          hex5_4_s1_agent_rdata_fifo_out_ready;                     // avalon_st_adapter:in_0_ready -> HEX5_4_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> HEX5_4_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> HEX5_4_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // HEX5_4_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> HEX5_4_s1_agent:rdata_fifo_sink_error
	wire          hex3_0_s1_agent_rdata_fifo_out_valid;                     // HEX3_0_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] hex3_0_s1_agent_rdata_fifo_out_data;                      // HEX3_0_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          hex3_0_s1_agent_rdata_fifo_out_ready;                     // avalon_st_adapter_001:in_0_ready -> HEX3_0_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                        // avalon_st_adapter_001:out_0_valid -> HEX3_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                         // avalon_st_adapter_001:out_0_data -> HEX3_0_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                        // HEX3_0_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                        // avalon_st_adapter_001:out_0_error -> HEX3_0_s1_agent:rdata_fifo_sink_error
